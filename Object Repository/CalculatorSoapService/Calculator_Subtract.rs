...
<WebServiceRequestEntity>
   ...
   <name>Calculator_Subtract</name>
   <tag></tag>
   <elementGuidId>fc7b7e9a-bb05-4725-a11b-ff357e630838</elementGuidId>
...
assertThat(response.getHeaderFields().get('Cache-Control').toString()).isEqualTo('[private, max-age=0]')</verificationScript>
